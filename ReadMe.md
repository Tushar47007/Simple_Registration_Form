...
A simple registraion form made using basic HTML and CSS which uses PHP in backend. Form takes basic user info as input and stores it on a database in PHP.\n
The website runs on a local server created using Xampp.\n
Screenshots: \n
