...
A simple registration form made using basic HTML, CSS and entry level JavaScript which uses PHP in backend. Form takes basic user info as input and stores it on a database in PHP.<br/>
